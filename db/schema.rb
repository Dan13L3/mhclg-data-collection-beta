...
ActiveRecord::Schema[7.0].define(version: 202202071123100) do
  ...
  create_table "case_logs", force: :cascade do |t|
    ...
    t.string "details_known_2"
    t.string "details_known_3"
    t.string "details_known_4"
    t.string "details_known_5"
    t.string "details_known_6"
    t.string "details_known_7"
    t.string "details_known_8"
